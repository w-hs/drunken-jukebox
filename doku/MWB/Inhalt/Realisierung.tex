...
\todo{Trennen nach Frontend und Backend}
...
Das PlayListEntryWidget ist ein Touch-Freundliches Widget für die VoteApp Komponente. Es dient der Song Darstellung in der Playlist mit zusätzlicher Eingabemöglichkeit zum Voten (UP oder DOWN). Es besteht aus zwei Labels zum anzeigen des Titels und des Interpreten und zwei Buttons zum UP-Voten und DOWN-Voten. 

Bild

Abbildung XX zeigt die Schnittstellenbeschreibung des PlayListEntryWidget. Im Konstruktor werden die beiden Labels mit Interpret und Titel aus dem PlayListEntry Erstellt. Weiter werden ClickHandler für die beiden Buttons hinzugefügt, welche die onUpVote bzw. onDownVote Methoden des Interfaces voteListener aufrufen. Die setVoteListener Methode setzt die Referenz auf den voteListener.
