...
Die Abbildung \ref{fig:Screenshot-Vote-App} zeigt die Oberfläche der VoteApp. Beim Voten ist uns aufgefallen, dass der Anwender keine Rückmeldung über seinen Vote erhält. Daher haben wir die Oberfläche im Vergleich zum Entwurf (Abb. \ref{fig:MockPartyPeopleClient}) um den Vote-Count erweitert. Beim Bestätigen der Up- bzw. Down-Buttons wird nun neben dem Vote-Count auch die Position des Songs entsprechend des Votings in der Playlist aktualisiert.
