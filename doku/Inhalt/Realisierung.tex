...
Über den Beans befindet sich das Topic und die REST-API. Ein Topic ist ein Messaging-Service, an den das PlayerBean den zu spielenden Song schickt und der diesen an alle zu dem Zeitpunkt registrierten Player-Clients weiterleitet. 
