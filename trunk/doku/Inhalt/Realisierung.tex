...
Die Song-Selection ist für die Befüllung der Playlist zuständig. Für die Auswahl der Songs haben wir einen eigenen Algorithmus entwickelt, der im Kapitel \nameref{sec:SongSelect} erklärt wird.
...
Die unterste Ebene mit dem Entity-Model beinhaltet die Persistenz-Logik. Mit Hilfe der JPA (Java Persistence API) und einer beliebigen Datenbank werden die Daten verwaltet.
